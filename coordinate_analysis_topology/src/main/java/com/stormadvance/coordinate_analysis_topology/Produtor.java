...
public class Produtor extends BaseBasicBolt{
	...
	public void execute(Tuple input, BasicOutputCollector collector) {
		...
		jMsg.put("nome_imagem", input.getStringByField("nome_imagem"));
		jMsg.put("latitude" , input.getDoubleByField("latitude"));
		jMsg.put("longitude", input.getDoubleByField("longitude"));

		producer.beginTransaction();
		producer.send(new ProducerRecord<String, String>("filaExibicaoCoordenada", jMsg.toString()));
